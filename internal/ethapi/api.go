...
import (
	...
	"github.com/ctt-chain/go-ethereum/common/math"
...
//
// https://github.com/ctt-chain/go-ethereum/wiki/Management-APIs#personal_sign
...
//
// https://github.com/ctt-chain/go-ethereum/wiki/Management-APIs#personal_ecRecover
...
func (s *PublicBlockChainAPI) doCall(ctx context.Context, args CallArgs, blockNr rpc.BlockNumber, vmCfg vm.Config) ([]byte, *big.Int, bool, error) {
	...
	msg := types.NewMessage(0,nil,nil,addr, args.To, 0, args.Value.ToInt(), gas, gasPrice, args.Data, false)
...
func (args *SendTxArgs) toTransaction() *types.Transaction {
	...
	return types.NewTransaction(args.Type, uint64(*args.Nonce), to, (*big.Int)(args.Value), (*big.Int)(args.Gas), (*big.Int)(args.GasPrice),0,nil,nil, args.Data)
}
...
// Version returns the current ethereum protocol version.
func (s *PublicNetAPI) PeerId() string {
	return s.net.NodeInfo().ID
}
